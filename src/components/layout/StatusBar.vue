  ...
  <footer class="h-6 border-t dark:border-[#333333] bg-white dark:bg-[#1e1e1e] flex items-center px-4 text-[10px] text-gray-500 dark:text-gray-400 justify-between shrink-0 select-none">
    <div class="flex items-center gap-4">
      <div class="flex items-center gap-1.5">
        ...
        <span>项目: {{ projectStore.currentProject?.title || '未加载项目' }}</span>
      </div>
      <div v-if="projectStore.isDirty" class="flex items-center gap-1 text-amber-600 dark:text-amber-400 font-medium animate-pulse">
